...
export default function ShowRequestedMeeting() {
  ...
  A minimum number of votes is required to approve a meeting, and admins can approve it once eligibility criteria are fulfilled.
</span>
...
<td onClick={() => router.push(`/showreport/${req._id}`)}>see report</td>
